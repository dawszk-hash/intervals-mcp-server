...
if __name__ == "__main__":
    ...
    # Override host and port from environment variables for deployment
    if "RENDER" in os.environ or "UVICORN_HOST" in os.environ:
        os.environ.setdefault("MCP_TRANSPORT", "sse")
        os.environ["HOST"] = os.getenv("UVICORN_HOST", "0.0.0.0")
        os.environ["PORT"] = os.getenv("UVICORN_PORT", "10000")
